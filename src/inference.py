...
from face_parsing.swap import  init_parser, swap_regions
...
def main():
	...
	if args.save_as_video:
		...
		pred_out = cv2.VideoWriter("temp/pred.avi", cv2.VideoWriter_fourcc(*'DIVX'), fps, (args.img_size, args.img_size))
	...
	print(command)
	#command = 'ffmpeg -i video.mp4 -i audio.mp3 -c:v copy -c:a aac -strict experimental output.mp4'
...
if __name__ == '__main__':
	...
	main()
#  python inference.py     --checkpoint_path "checkpoints/wav2lip_gan.pth"     --segmentation_path "checkpoints/face_segmentation.pth"     --sr_path "checkpoints/esrgan_yunying.pth"     --face video4.mp4     --audio audio --outfile response.mp4 --no_sr
